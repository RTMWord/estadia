...
<head>
    <meta charset="UTF-8">
    <title>Nuevo Servicio - MetaHogar</title>
    <link rel="stylesheet" href="../assets/css/style.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container py-5">
        <h2 class="text-primary mb-4">Crear Nuevo Servicio</h2>
        <form method="POST" action="../../app/controllers/ServicioController.php">
            ...
            <div class="mb-3">
                ...
                <select name="agencia" class="form-select">
                    ...
                    <?php foreach ($agencias as $a): ?>
                        <option value="<?= $a['idAgencia'] ?>"><?= $a['Nombre'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" name="crear" class="btn btn-success">Crear Servicio</button>
