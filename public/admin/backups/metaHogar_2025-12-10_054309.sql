...
INSERT INTO `agencia` VALUES (1,'Agencia de enfermeras','Juan Sanchez Godoy','7772319257','17250902@uagro.mx','aguilas 18 manzana 1 Cond tarianes','PENDIENTE');
...
INSERT INTO `carousel_testimonios` VALUES (1,1,0,1);
...
INSERT INTO `contenido` VALUES (1,'ARTICULO','Información que cura','Este es un mensaje de prueba para que podamos observar la insuficiencia de este sistema',NULL,'2025-11-24 17:46:10',1);
...
INSERT INTO `multimedia` VALUES (1,NULL,'IMAGEN','assets/media/media_1763523364_9433.jpeg','ejemplo clave');
...
INSERT INTO `producto` VALUES (1,'vendas','descripcion random',12.00,777,1);
...
INSERT INTO `rol` VALUES (1,'administrador','Administrador del sistema'),(2,'Usuario','Ciudadano / Familiar / Adulto mayor');
...
INSERT INTO `usuario` VALUES (1,'Admin','Meta','Hogar','admin@example.com','$2y$10$LhX65waxtcCTcX8/itF51Orv97X4bSvfukhHok4LH64LS4wnDiP6.','','2025-11-03 17:37:57',1,'interno','2025-12-09 22:38:42',0,NULL,NULL,NULL),(2,'Alexis','Reyes','Ocampo','alexis.re.ye.es.14@gmail.com','$2y$10$MTOSETstvfCcfTTWWXGhFefApmPHw7pz2O4aVh7sEk/x2zcFAxlFy','7772319257','2025-11-06 23:00:28',1,'externo','2025-12-09 22:41:04',0,NULL,'587f5d201bf227c1aec0164e8f71db9a785cb102bce4a196b5930862c7ae05b5','2025-11-15 04:08:57'),(3,'Alexis','Reyes','Ocampo','reysalexis3@gmail.com','$2y$10$qK0jg0SCiKc0UohBcMaOU.aKKzNdTAfqXICjiZQ5TqUec5cbAZCsy','7772319257','2025-11-08 02:25:40',1,'externo',NULL,0,NULL,NULL,NULL),(4,'Juan 55','Reyes','Ocampo5','alex_iss11@outlook.com','$2y$10$85UFFJgN6xMb68mklCmS4O9u6D.71.jt5yWnM1McPfh7uLQ7rq2rC','7772319257','2025-11-13 23:28:07',0,'externo','2025-12-09 22:41:10',0,NULL,NULL,NULL),(5,'Alexis','Reyes','Ocampo','rklcolek@outlook.com','$2y$10$ge.eLz.Eo9XwejFwp65aHeDLoCXPY6hc4AE/f.7pECHrcQAgTuroO','7772319257','2025-11-13 23:37:42',0,'interno','2025-11-13 23:43:09',1,NULL,NULL,NULL);
...
INSERT INTO `usuariorol` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1),(5,5,2);
...
-- Dump completed on 2025-12-09 22:43:09
