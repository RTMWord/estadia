...
CREATE TABLE `accesibilidad` (
  `idAccesibilidad` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_Accesibilidad_Usuario` (`Usuario_idUsuario`),
...
--
-- Table structure for table `auditoriapedido`
--

DROP TABLE IF EXISTS `auditoriapedido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `auditoriapedido`
--

LOCK TABLES `auditoriapedido` WRITE;
/*!40000 ALTER TABLE `auditoriapedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoriapedido` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `auditoriaproducto`
--
...
--
-- Dumping data for table `auditoriaproducto`
--

LOCK TABLES `auditoriaproducto` WRITE;
/*!40000 ALTER TABLE `auditoriaproducto` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditoriaproducto` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pedido` (
  ...
  KEY `idx_pedido_usuario_fecha` (`Usuario_idUsuario`,`FechaPedido`),
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_pedido_insert` AFTER INSERT ON `pedido` FOR EACH ROW BEGIN
...
INSERT INTO `usuario` VALUES (1,'Admin','Meta','Hogar','admin@example.com','$2y$10$LhX65waxtcCTcX8/itF51Orv97X4bSvfukhHok4LH64LS4wnDiP6.','','2025-11-03 17:37:57',1,'interno','2025-11-08 00:52:10',0,NULL,NULL,NULL),(2,'Alexis','Reyes','Ocampo','alexis.re.ye.es.14@gmail.com','$2y$10$MTOSETstvfCcfTTWWXGhFefApmPHw7pz2O4aVh7sEk/x2zcFAxlFy','7772319257','2025-11-06 23:00:28',1,'externo','2025-11-06 23:18:01',0,NULL,NULL,NULL);
...
INSERT INTO `usuariorol` VALUES (1,1,1),(2,2,1);
...
-- Dump completed on 2025-11-08  1:24:44
