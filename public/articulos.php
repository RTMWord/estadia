    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <article class="card mb-4">
                <div class="card-body">
                    <h3 class="card-title"><a href="articulo_post.php?id=<?= $it['idContenido'] ?>"><?= htmlspecialchars($it['Titulo']) ?></a></h3>
                    ...
                    <a href="articulo_post.php?id=<?= $it['idContenido'] ?>" class="btn btn-sm btn-primary">Leer más</a>
                </div>
            </article>
            <?php endforeach; ?>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        foreach ($items as $it) {
                            ...
                            $count++;
                            if ($count > 5) break;
                            echo '<li><a href="articulo_post.php?id=' . $it['idContenido'] . '">' . htmlspecialchars($it['Titulo']) . '</a></li>';
                        }
